...
A very simple application to demonstrate the use of Apache Wicket in an 
Apache Karaf container. This time Apache Shiro based security is added
for role based page access.
